...
export default function Wishlist({crrUser}) {
  ...
  {crrUser?.name != null ?  <h3 className='mt-5 pt-5 text-success fw-bolder text-center text-muted'>Welcome {crrUser.name} to your Wishlist <i class="fa-solid fa-heart text-danger"></i> </h3> : '' };
